...
const commandClass =
  "relative isolate grid min-h-16 grid-cols-[minmax(220px,320px)_minmax(260px,1fr)_auto] items-center gap-4 px-2.5 py-1.5 [--apm-command-control-height:40px] max-[980px]:grid-cols-1 after:pointer-events-none after:absolute after:left-1/2 after:top-[-1px] after:h-px after:w-[min(960px,82%)] after:-translate-x-1/2 after:animate-[apm-command-line-breathe_5.6s_ease-in-out_infinite] after:bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--apm-riviera)_52%,transparent),color-mix(in_srgb,var(--apm-radio-silence)_54%,transparent),transparent)] after:opacity-[.58] after:shadow-[0_0_18px_color-mix(in_srgb,var(--apm-radio-silence)_28%,transparent),0_14px_28px_rgba(0,0,0,.34)]";
...
const searchFieldClass =
  "relative flex h-[var(--apm-command-control-height)] min-h-[var(--apm-command-control-height)] items-center gap-2 rounded-[16px_8px_16px_8px] border border-[color-mix(in_srgb,var(--apm-radio-silence)_30%,transparent)] bg-[radial-gradient(circle_at_86%_24%,color-mix(in_srgb,var(--apm-radio-silence)_10%,transparent),transparent_38%),linear-gradient(180deg,rgba(9,22,24,.84),rgba(3,8,12,.72))] px-3 shadow-[0_0_28px_color-mix(in_srgb,var(--apm-radio-silence)_12%,transparent),inset_0_1px_0_rgba(255,255,255,.08),inset_0_0_24px_color-mix(in_srgb,var(--apm-radio-silence)_7%,transparent)] before:absolute before:bottom-0 before:left-[18px] before:right-[18px] before:h-px before:bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--apm-radio-silence)_50%,transparent),transparent)] before:opacity-[.82]";
...
const commandButtonBaseClass =
  "inline-flex h-[var(--apm-command-control-height)] min-h-[var(--apm-command-control-height)] cursor-pointer items-center justify-center gap-1.5 border border-[color-mix(in_srgb,currentColor_22%,transparent)] ![background:linear-gradient(180deg,rgba(255,255,255,.07),rgba(255,255,255,.02)),rgba(5,13,18,.68)] text-[var(--apm-radio-silence)] shadow-[0_0_18px_color-mix(in_srgb,currentColor_14%,transparent),inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-lg transition-[transform,box-shadow,border-color] duration-[180ms] hover:shadow-[0_10px_22px_rgba(0,0,0,.24),0_0_24px_color-mix(in_srgb,currentColor_22%,transparent),inset_0_1px_0_rgba(255,255,255,.12)]";
const importControlClass =
  "inline-flex h-[var(--apm-command-control-height)] min-h-[var(--apm-command-control-height)] items-center rounded-[16px_8px_16px_8px] shadow-[0_0_20px_color-mix(in_srgb,var(--apm-mamas-new-bag)_13%,transparent)]";
const importPrimaryClass = `${commandButtonBaseClass} m-0 min-w-[132px] self-stretch rounded-[14px_0_0_7px] border-r-[color-mix(in_srgb,var(--apm-mamas-new-bag)_18%,transparent)] text-[var(--apm-mamas-new-bag)]`;
